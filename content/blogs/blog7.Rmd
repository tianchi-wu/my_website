...
The plot that we want to reproduce.
...
We want to reproduce this plot to see changes of proportion of each component of GDP.
...
#save the picture
ggsave("gdp2.jpg",plot=gdp2,width = 20,height = 10, path = here::here("images"))
